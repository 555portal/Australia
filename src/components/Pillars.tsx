const pillars = [
  {
    ...
    body: "MII's global team of digital ministry specialists equip your team across strategy, content, advertising, persona development, and how to reach your specific mission field online.",
  },
  {
    num: '02',
